...
public class TeacherSubjectJoinEndpoint {
    ...
    public static HttpResponse read(HttpPostRequest req,
        ...
        try {
            RequestModel<TeacherSubjectJoin> requestModel = RequestModel.fromJson(TeacherSubjectJoin.class, new String((byte[]) req.getContent()
                    .getData()));
            return res.setContent(CommonService.read(TeacherSubjectJoin.class, requestModel).parse());
        } catch (Exception e) {
            logger.atError().log(e.getMessage());
            return res.setContent(new Response<TeacherSubjectJoin>().setError(ResponseError.JSON_PARSE_ERROR).parse());
        }
    }
    ...
    public static HttpResponse create(HttpPostRequest req,
        ...
        try {
            RequestModel<TeacherSubjectJoin> requestModel = RequestModel.fromJson(TeacherSubjectJoin.class, new String((byte[]) req.getContent()
                    .getData()));
            return res.setContent(CommonService.create(TeacherSubjectJoin.class, requestModel).parse());
        } catch (Exception e) {
            logger.atError().log(e.getMessage());
            return res.setContent(new Response<TeacherSubjectJoin>().setError(ResponseError.JSON_PARSE_ERROR).parse());
        }
    ...
    public static HttpResponse update(HttpPostRequest req,
        ...
        try {
            RequestModel<TeacherSubjectJoin> requestModel = RequestModel.fromJson(TeacherSubjectJoin.class, new String((byte[]) req.getContent()
                    .getData()));
            return res.setContent(CommonService.update(TeacherSubjectJoin.class, requestModel).parse());
        } catch (Exception e) {
            logger.atError().log(e.getMessage());
            return res.setContent(new Response<TeacherSubjectJoin>().setError(ResponseError.JSON_PARSE_ERROR).parse());
        }
    ...
    public static HttpResponse delete(HttpPostRequest req,
        ...
        try {
            RequestModel<TeacherSubjectJoin> requestModel = RequestModel.fromJson(TeacherSubjectJoin.class, new String((byte[]) req.getContent()
                    .getData()));
            return res.setContent(CommonService.delete(TeacherSubjectJoin.class, requestModel).parse());
        } catch (Exception e) {
            logger.atError().log(e.getMessage());
            return res.setContent(new Response<TeacherSubjectJoin>().setError(ResponseError.JSON_PARSE_ERROR).parse());
        }
