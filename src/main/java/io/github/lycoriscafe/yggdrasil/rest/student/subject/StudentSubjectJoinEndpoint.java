...
public class StudentSubjectJoinEndpoint {
    private static final Logger logger = LoggerFactory.getLogger(StudentSubjectJoinEndpoint.class);
    ...
    public static HttpResponse read(HttpPostRequest req,
        ...
        try {
            RequestModel<StudentSubjectJoin> requestModel = RequestModel.fromJson(StudentSubjectJoin.class, new String((byte[]) req.getContent()
                    .getData()));
            return res.setContent(CommonService.read(StudentSubjectJoin.class, requestModel).parse());
        } catch (Exception e) {
            logger.atError().log(e.getMessage());
            return res.setContent(new Response<StudentSubjectJoin>().setError(ResponseError.JSON_PARSE_ERROR).parse());
        }
    }
    ...
    public static HttpResponse create(HttpPostRequest req,
        ...
        try {
            RequestModel<StudentSubjectJoin> requestModel = RequestModel.fromJson(StudentSubjectJoin.class, new String((byte[]) req.getContent()
                    .getData()));
            return res.setContent(CommonService.create(StudentSubjectJoin.class, requestModel).parse());
        } catch (Exception e) {
            logger.atError().log(e.getMessage());
            return res.setContent(new Response<StudentSubjectJoin>().setError(ResponseError.JSON_PARSE_ERROR).parse());
        }
    ...
    public static HttpResponse update(HttpPostRequest req,
        ...
        try {
            RequestModel<StudentSubjectJoin> requestModel = RequestModel.fromJson(StudentSubjectJoin.class, new String((byte[]) req.getContent()
                    .getData()));
            return res.setContent(CommonService.update(StudentSubjectJoin.class, requestModel).parse());
        } catch (Exception e) {
            logger.atError().log(e.getMessage());
            return res.setContent(new Response<StudentSubjectJoin>().setError(ResponseError.JSON_PARSE_ERROR).parse());
        }
    ...
    public static HttpResponse delete(HttpPostRequest req,
        ...
        try {
            RequestModel<StudentSubjectJoin> requestModel = RequestModel.fromJson(StudentSubjectJoin.class, new String((byte[]) req.getContent()
                    .getData()));
            return res.setContent(CommonService.delete(StudentSubjectJoin.class, requestModel).parse());
        } catch (Exception e) {
            logger.atError().log(e.getMessage());
            return res.setContent(new Response<StudentSubjectJoin>().setError(ResponseError.JSON_PARSE_ERROR).parse());
        }
