...
public class TimetableEndpoint {
    ...
    public static HttpResponse read(HttpGetRequest req,
        ...
        var auth = AuthenticationService.authenticate(req, new Role[]{Role.ADMIN, Role.TEACHER, Role.STUDENT},
                AccessLevel.SUPERUSER, AccessLevel.TIMETABLE);
        if (auth != null) return auth;

        return res.setContent(TimetableService.select(SearchQueryBuilder.build(
                Timetable.class, TimetableService.Columns.class, TimetableService.class,
    ...
    public static HttpResponse create(HttpPostRequest req,
        ...
        return res.setContent(TimetableService.insert(UpdateQueryBuilder.build(
                Timetable.class, TimetableService.Columns.class, TimetableService.class,
    ...
    public static HttpResponse update(HttpPostRequest req,
        ...
        return res.setContent(TimetableService.update(UpdateQueryBuilder.build(
                Timetable.class, TimetableService.Columns.class, TimetableService.class,
                req.getParameters(), (List<MultipartFormData>) req.getContent().getData())).parse());
    }
    ...
    public static HttpResponse delete(HttpDeleteRequest req,
        ...
        return res.setContent(TimetableService.delete(SearchQueryBuilder.build(
                Timetable.class, TimetableService.Columns.class, TimetableService.class,
                req.getParameters())).parse());
    }
}
